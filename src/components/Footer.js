            ...
            <div className="footer-container">
                ...
                <div className="right">
                    ...
                    <div className="social">
                        <FaGithub size={30} style={{ color: 'green', marginRight: '1rem' }} />

                        <FaLinkedin size={30} style={{ color: 'green', marginRight: '1rem' }} />

                        <FaInstagram size={30} style={{ color: 'green', marginRight: '1rem' }} />
